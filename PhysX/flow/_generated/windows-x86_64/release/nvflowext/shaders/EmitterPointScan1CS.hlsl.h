#include "EmitterPointScan1CS_vulkan.hlsl.h"
#include "EmitterPointScan1CS_d3d12.hlsl.h"

struct EmitterPointScan1CS_Pipeline
{
	NvFlowContextInterface* contextInterface;
	NvFlowComputePipeline* pipeline;
};

inline void EmitterPointScan1CS_init(NvFlowContextInterface* contextInterface, NvFlowContext* context, EmitterPointScan1CS_Pipeline* ptr)
{
	ptr->contextInterface = contextInterface;
	NvFlowContextConfig config = {};
	ptr->contextInterface->getContextConfig(context, &config);
	NvFlowBindingDesc bindingDescs[13] = {};
	...
	if (config.api == eNvFlowContextApi_vulkan)
	{
		...
		bindingDescs[10].type = eNvFlowDescriptorType_rwStructuredBuffer;
		...
		bindingDescs[11].type = eNvFlowDescriptorType_rwStructuredBuffer;
		...
		bindingDescs[12].type = eNvFlowDescriptorType_rwStructuredBuffer;
		...
		desc.numBindingDescs = 13;
		desc.bindingDescs = bindingDescs;
		desc.bytecode.data = EmitterPointScan1CS_vulkan_hlsl;
		desc.bytecode.sizeInBytes = sizeof(EmitterPointScan1CS_vulkan_hlsl);
	}
	if (config.api == eNvFlowContextApi_d3d12)
	{
		...
		bindingDescs[11].bindingDesc.d3d12.registerBegin = 1;
		...
		bindingDescs[12].bindingDesc.d3d12.registerBegin = 2;
		bindingDescs[12].bindingDesc.d3d12.numRegisters = 1;
		bindingDescs[12].bindingDesc.d3d12.space = 0;

		desc.numBindingDescs = 13;
		desc.bindingDescs = bindingDescs;
		desc.bytecode.data = EmitterPointScan1CS_d3d12_hlsl;
		desc.bytecode.sizeInBytes = sizeof(EmitterPointScan1CS_d3d12_hlsl);
	}
	ptr->pipeline = ptr->contextInterface->createComputePipeline(context, &desc);
};

inline void EmitterPointScan1CS_destroy(NvFlowContext* context, EmitterPointScan1CS_Pipeline* ptr)
{
	ptr->contextInterface->destroyComputePipeline(context, ptr->pipeline);
}

struct EmitterPointScan1CS_PassParams
{
	NvFlowBufferTransient* gParams;
	NvFlowBufferTransient* gSubStepParams;
	NvFlowBufferTransient* reduceTarget1In;
	NvFlowBufferTransient* reduceCouple1In;
	NvFlowBufferTransient* reduceWeight1In;
	NvFlowBufferTransient* key1In;
	NvFlowBufferTransient* scanTarget2In;
	NvFlowBufferTransient* scanCouple2In;
	NvFlowBufferTransient* scanWeight2In;
	NvFlowBufferTransient* key2In;
	NvFlowBufferTransient* scanTarget1Out;
	NvFlowBufferTransient* scanCouple1Out;
	NvFlowBufferTransient* scanWeight1Out;
};

inline void EmitterPointScan1CS_addPassCompute(NvFlowContext* context, EmitterPointScan1CS_Pipeline* ptr, NvFlowUint3 gridDim, const EmitterPointScan1CS_PassParams* params)
{
	NvFlowContextConfig config = {};
	ptr->contextInterface->getContextConfig(context, &config);
	NvFlowDescriptorWrite descriptorWrites[13] = {};
	NvFlowResource resources[13] = {};
	...
	if (config.api == eNvFlowContextApi_vulkan)
	{
		...
		resources[2].bufferTransient = params->reduceTarget1In;
		...
		resources[3].bufferTransient = params->reduceCouple1In;
		...
		resources[4].bufferTransient = params->reduceWeight1In;
		...
		resources[5].bufferTransient = params->key1In;
		...
		resources[6].bufferTransient = params->scanTarget2In;
		...
		resources[7].bufferTransient = params->scanCouple2In;
		...
		resources[8].bufferTransient = params->scanWeight2In;
		...
		resources[9].bufferTransient = params->key2In;

		descriptorWrites[10].type = eNvFlowDescriptorType_rwStructuredBuffer;
		...
		resources[10].bufferTransient = params->scanTarget1Out;

		descriptorWrites[11].type = eNvFlowDescriptorType_rwStructuredBuffer;
		...
		resources[11].bufferTransient = params->scanCouple1Out;

		descriptorWrites[12].type = eNvFlowDescriptorType_rwStructuredBuffer;
		...
		resources[12].bufferTransient = params->scanWeight1Out;

		passComputeParams.numDescriptorWrites = 13;
		passComputeParams.descriptorWrites = descriptorWrites;
		passComputeParams.resources = resources;
		passComputeParams.debugLabel = "EmitterPointScan1CS";
	}
	if (config.api == eNvFlowContextApi_d3d12)
	{
		descriptorWrites[0].type = eNvFlowDescriptorType_constantBuffer;
