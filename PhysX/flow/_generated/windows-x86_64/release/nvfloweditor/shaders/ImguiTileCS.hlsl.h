#include "ImguiTileCS_vulkan.hlsl.h"
#include "ImguiTileCS_d3d12.hlsl.h"
...
inline void ImguiTileCS_init(NvFlowContextInterface* contextInterface, NvFlowContext* context, ImguiTileCS_Pipeline* ptr)
{
	...
	if (config.api == eNvFlowContextApi_vulkan)
	{
		...
		desc.bytecode.data = ImguiTileCS_vulkan_hlsl;
		desc.bytecode.sizeInBytes = sizeof(ImguiTileCS_vulkan_hlsl);
	}
	if (config.api == eNvFlowContextApi_d3d12)
	{
		...
		desc.numBindingDescs = 6;
		desc.bindingDescs = bindingDescs;
		desc.bytecode.data = ImguiTileCS_d3d12_hlsl;
		desc.bytecode.sizeInBytes = sizeof(ImguiTileCS_d3d12_hlsl);
	}
