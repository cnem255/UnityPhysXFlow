#include "ImguiBuildCS_vulkan.hlsl.h"
#include "ImguiBuildCS_d3d12.hlsl.h"
...
inline void ImguiBuildCS_init(NvFlowContextInterface* contextInterface, NvFlowContext* context, ImguiBuildCS_Pipeline* ptr)
{
	...
	if (config.api == eNvFlowContextApi_vulkan)
	{
		...
		desc.bytecode.data = ImguiBuildCS_vulkan_hlsl;
		desc.bytecode.sizeInBytes = sizeof(ImguiBuildCS_vulkan_hlsl);
	}
	if (config.api == eNvFlowContextApi_d3d12)
	{
		...
		desc.numBindingDescs = 6;
		desc.bindingDescs = bindingDescs;
		desc.bytecode.data = ImguiBuildCS_d3d12_hlsl;
		desc.bytecode.sizeInBytes = sizeof(ImguiBuildCS_d3d12_hlsl);
	}
