#include "ImguiTileCountCS_vulkan.hlsl.h"
#include "ImguiTileCountCS_d3d12.hlsl.h"
...
inline void ImguiTileCountCS_init(NvFlowContextInterface* contextInterface, NvFlowContext* context, ImguiTileCountCS_Pipeline* ptr)
{
	...
	if (config.api == eNvFlowContextApi_vulkan)
	{
		...
		desc.bytecode.data = ImguiTileCountCS_vulkan_hlsl;
		desc.bytecode.sizeInBytes = sizeof(ImguiTileCountCS_vulkan_hlsl);
	}
	if (config.api == eNvFlowContextApi_d3d12)
	{
		...
		desc.numBindingDescs = 3;
		desc.bindingDescs = bindingDescs;
		desc.bytecode.data = ImguiTileCountCS_d3d12_hlsl;
		desc.bytecode.sizeInBytes = sizeof(ImguiTileCountCS_d3d12_hlsl);
	}
