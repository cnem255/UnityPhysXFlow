#include "ImguiTileScanCS_vulkan.hlsl.h"
#include "ImguiTileScanCS_d3d12.hlsl.h"
...
inline void ImguiTileScanCS_init(NvFlowContextInterface* contextInterface, NvFlowContext* context, ImguiTileScanCS_Pipeline* ptr)
{
	...
	if (config.api == eNvFlowContextApi_vulkan)
	{
		...
		desc.bytecode.data = ImguiTileScanCS_vulkan_hlsl;
		desc.bytecode.sizeInBytes = sizeof(ImguiTileScanCS_vulkan_hlsl);
	}
	if (config.api == eNvFlowContextApi_d3d12)
	{
		...
		desc.numBindingDescs = 3;
		desc.bindingDescs = bindingDescs;
		desc.bytecode.data = ImguiTileScanCS_d3d12_hlsl;
		desc.bytecode.sizeInBytes = sizeof(ImguiTileScanCS_d3d12_hlsl);
	}
